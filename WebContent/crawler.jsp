...
<body>
	...
	<div class="container">
		<form id="crawlerform" class="form-horizontal" role="form"
			...
			<div class="form-group">
				<input type="radio" name="document_type" value="10-K" checked>10K
<br>
<input type="radio" name="document_type" value="10-Q">10Q
<br>
		...
		$("#begincrawl")
				.click(
						function(event) {
							...
							var crawlurl = "/api/crawl/" + symbol + document_type;
							$
									.ajax({
										url : crawlurl,
